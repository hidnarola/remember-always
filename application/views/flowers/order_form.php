                    ...
                    <form method="post" enctype="multipart/form-data" id="cart_form">
                        <div class="delivery_l">
                            ...
                            <div class="input-wrap">
                                ...
                                <i class="fa fa-info-circle" aria-hidden="true" data-placement="left" title="Name of person receiving flowers. If this is for a funeral home, please put the name of the deceased here."></i>
                            </div>
                            <div class="input-wrap">
                                <input type="text" name="r_institute" placeholder="Institution" class="input-css">
                                <i class="fa fa-info-circle" aria-hidden="true" data-placement="left" title="If these flowers are going to an institution, such as a business or a funeral home, please put the name of that institution here."></i>
                            </div>
                            <div class="input-wrap">
                            ...
                            <div class="input-wrap">
                                ...
                                <i class="fa fa-info-circle" aria-hidden="true" data-placement="left" title="5 digit Zip Code for United States, example: 10118 | 7 character Postal Code for Canada, example: M5V 2T6"></i>
                            </div>
