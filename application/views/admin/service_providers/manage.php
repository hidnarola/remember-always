                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="street2" id="street2" class="form-control" value="<?php echo isset($provider_data['street2']) ? $provider_data['street2'] : set_value('street2'); ?>" readonly="">
                                    </div>
                                </div>
                                <div class="row form-group mt-5">
                                    <div class="col-md-4">
                                        <label>City: <span class="text-danger">*</span></label>
                                        <input type="text" name="city" id="city" class="form-control" value="<?php echo isset($provider_data['city']) ? $provider_data['city'] : set_value('city'); ?>" readonly="">
                                    </div>
                                    <div class="col-md-4">
                                        <label>State: <span class="text-danger">*</span></label>
                                        <input type="text" name="state" id="state" class="form-control" value="<?php echo isset($provider_data['state']) ? $provider_data['state'] : set_value('state'); ?>" readonly="">
                                    </div>
                                    <div class="col-md-4">
