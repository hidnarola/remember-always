...
class Home extends MY_Controller {
    ...
    public function test() {
        ...
        echo shell_exec('/usr/local/bin/ffmpeg -i /var/www/html/uploads/post-images/5a27691f2dc501512532255.png -vf scale=500:-1 /var/www/html/uploads/post-images/new_1.png 2>&1');
        exit;
        /*
          echo shell_exec('whoami');
