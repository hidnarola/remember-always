                            ...
                            <div class="step-01-l-wrap">
                                ...
                                <div class="step-01-m">
                                    ...
                                    <div class="input-wrap">
                                        <input type="text" id="firstname" name="firstname" placeholder="First Name" class="input-css" value="<?php echo (set_value('firstname') != '') ? set_value('firstname') : $this->session->userdata('profile')['firstname'] ?>" required/>
                                        <!--<label id="firstname-error" class="error" for="firstname"><?php echo form_error('firstname') ?></label>-->
                                    </div>
                                    <div class="input-wrap">
                                        <input type="text" id="middlename" name="middlename" placeholder="Middle Name" class="input-css" value="<?php echo (set_value('middlename') != '') ? set_value('middlename') : $this->session->userdata('profile')['middlename'] ?>" />
                                    </div>
                                    <div class="input-wrap">
                                        <input type="text" id="lastname" name="lastname" placeholder="Last Name" class="input-css" value="<?php echo (set_value('lastname') != '') ? set_value('lastname') : $this->session->userdata('profile')['lastname'] ?>" required/>
                                        <!--<label id="lastname-error" class="error" for="lastname"><?php echo form_error('lastname') ?></label>-->
                                    </div>
                                    <div class="input-wrap">
                                        <input type="text" name="nickname" id="nickname" placeholder="Nick Name" class="input-css" value="<?php echo (set_value('nickname') != '') ? set_value('nickname') : $this->session->userdata('profile')['nickname'] ?>"/>
                                    </div>
                                    <div class="input-wrap">
                                        <div class="input-l">
