...
<section class="new-column top-spacing">
    <div class="container">
        <div class="column-wrap top-section">
            <div class="text-wrap">
                <h1>Create a Tribute Fundraiser for your loved one’s <br/>cause or to help cover expenses.</h1>
                <p>Easily create a fundraiser, as a part of your loved one’s memorial Life Profile, to <br/> get financial support.</p>
                <p>This can help with funeral expenses, medical bills, benefit a cause that your loved <br/> one held dear, or more. </p>
                <p>Family and friends will be honored to support.</p>
                <div class="btn-wrap-div">
                    <a href="<?php echo site_url('profile/create_profile') ?>">Get Started</a><span>Fundraiser is free to create. <br/> Nominal service fee on donations only.</span>
                </div>	
            </div>
...
<section class="new-process">
    <h2>Get the help & support you need <br/> by creating a Tribute Fundraiser in a few easy steps</h2>
    <ul>
        <li><span>1</span> <strong>Create</strong></li>
        <li><span>2</span> <strong>Share</strong></li>
        <li><span>3</span> <strong>Get Support</strong></li>
    </ul>
</section>
...
<section class="new-column">
    <div class="container">
        <div class="column-wrap">
            <div class="text-wrap">
                <small>CREATE</small>
                <h3>Create a Tribute Fundraiser as a part of  <br/> a memorial Life Profile.</h3>
                <p>You can start by adding the minimum content for your loved one’s Life Profile.</p>
                <p>Then complete the Tribute Fundraiser section.</p>
...
<section class="new-column rtl-bg">
    <div class="container">
        <div class="column-wrap">
            ...
            <div class="text-wrap">
                <small>SHARE & GET SUPPORT</small>
                <h3>Share the Tribute Fundraiser, as a part of the memorial <br/> Life Profile, and receive the support you need.</h3>
                ...
                <p>Easily share the Life Profile, which includes the Tribute Fundraiser, with family and friends, near and far.</p>
                <p>Ohers will be honored to support by donating to your fundraiser. You will receive the donations quickly.</p>
                <p>Remember together and support each other in your loved one’s honor. </p>
...
<section class="new-column">
    <div class="container">
        <div class="column-wrap">
            <div class="text-wrap">
                <small>WHY?</small>
                <h3>Why create a Tribute Fundraiser? <br/> There are many possible reasons for creating a Tribute Fundraiser. <br/> Here are a few …</h3>
                <p>1. To help with funeral expenses</p>
                <p>2. Help with outstanding medical bills</p>
                <p>3. To benefit the children of your loved one</p>
                <p>4.  To benefit your loved ones’ charity or cause</p>
                <div class="btn-wrap-div"><a href="<?php echo site_url('profile/create_profile') ?>">Get Started</a></div>
            </div>
