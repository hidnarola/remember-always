                        ...
                        <div id="first-step">
                            <div class="step-01-l-wrap">
                                ...
                                <div class="step-01-m">
                                    ...
                                    <div class="input-wrap">
                                        <div class="input-l">
                                            <input type="text" name="date_of_birth" id="date_of_birth" placeholder="Born (mm/dd/yyyy)" class="input-css date-picker" value="<?php echo set_value('date_of_birth') ?>" required/>
                                        ...
                                        <div class="input-r">
                                            <input type="text" name="date_of_death" id="date_of_death" placeholder="Died (mm/dd/yyyy)" class="input-css date-picker" value="<?php echo set_value('date_of_death') ?>" required/>
