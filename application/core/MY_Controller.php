    ...
    public function __construct() {
        ...
        if ($directory == 'admin/') {
            ...
            if ($this->is_user_loggedin) {
                ...
                $this->tribute_profile_count = $this->users_model->sql_select(TBL_PROFILES, 'slug', ['where' => ['is_delete' => 0, 'type' => 1, 'user_id' => $this->user_id]], ['count' => true]);
                if ($this->tribute_profile_count == 1) {
                    $this->tribute_profile = $this->users_model->sql_select(TBL_PROFILES, 'slug', ['where' => ['is_delete' => 0, 'type' => 1, 'user_id' => $this->user_id]], ['single' => true]);
                }
